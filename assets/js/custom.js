(function ($) {
	...
	if (elem) {
	    ...
	    if (filtersElem) {
	        filtersElem.addEventListener('click', function(event) {
	            ...
	            filtersElem.querySelectorAll('a').forEach(filterBtn => {
	                filterBtn.classList.remove('is_active');
	            });
	...
	document.addEventListener('DOMContentLoaded', function () {
	    const videoItems = document.querySelectorAll('.events_item video');
	    const videoOverlay = document.querySelector('.video-overlay');
	    const overlayVideo = videoOverlay.querySelector('video');
	...
	// Manejo de enlaces de YouTube en el carrusel
  $('.main-button a[href*="youtube"]').on('click', function(e) {
    e.preventDefault();
